    ...
    <section>
        <div class="container-fluid px-0">
            <div class="mt-0 mt-lg-0">
                <div class="mt-0 mt-lg-4"><img class="w-100" src="{{ asset('assets/img/register_img.jpg') }}">
                </div>
            </div>
        </div>
    </section>
                    ...
                    <form class="register_form">
                        <div class="row mx-0">
                            <div class="col col-12 col-md-6 ps-0 pe-0 pe-md-2">
                                <div><label class="form-label form_label">WHO ARE YOU ?</label><select
                                        class="form-select select_input register_role">
                            ...
                            <div class="col col-12 col-md-6 pe-0 ps-0 ps-md-2 mt-4 mt-md-0">
                                <div class="date_input ms-auto"><label
                                        ...
                                        class="form-control ms-auto w-100" type="date"></div>
                            </div>
                        </div>
                        <div class="mt-4">
                            <div><label class="form-label form_label"><strong>FULL NAME&nbsp; *&nbsp;</strong></label><input
                            ...
                            <div class="mt-2"><label class="form-label form_label"><strong>E-MAIL
                                        ADDRESS&nbsp;*</strong><br></label><input class="form-control" type="email"></div>
                            <div class="mt-2"><label class="form-label form_label"><strong>PHONE
                                        NUMBER&nbsp;</strong><br></label><input class="form-control" type="number"></div>
                            <div class="mt-2"><label class="form-label form_label"><strong>AREA&nbsp;*
                                        &nbsp;</strong><br></label><input class="form-control" type="text"></div>
