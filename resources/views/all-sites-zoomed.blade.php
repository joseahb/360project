...
<body>
    ...
    <section>
        <div class="container-fluid px-0 position-relative"><iframe allowfullscreen="" frameborder="0" loading="lazy" src="https://www.google.com/maps/embed/v1/search?key=AIzaSyBtfhZ_trDn_XdGhtTOtD-ckaGxG1WZLTk&amp;q=Big+Ben%2C+Greenwich&amp;zoom=15" width="100%" height="400" style="height: 600px;"></iframe>
            ...
            <div class="map_slider_div d-none d-lg-block">
                <div class="demo_slide_div"></div>
                <div class="d-flex">
                    <div class="map_info_div w-100 d-flex align-items-center">
                        <div>
                            <h1 class="map_card_title mb-0"><strong>Title&nbsp;</strong></h1><span class="map_card_span">Info</span>
                        </div><a class="btn register_div_btn ms-auto" role="button" href="register.html"><strong>View Gallery</strong><br></a>
                    </div>
                </div>
            </div>
        </div>
