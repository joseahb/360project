...
<body>
    ...
    <div class="title_div">
        <div class="container-fluid ps-0 ps-xl-5 text-center text-xl-start">
            <h1 class="title_div_heading"><strong>PREVIOUS DEVELOPMENTS-</strong><br></h1>
        </div>
    </div>
    <section class="section_padding">
        <div class="container-fluid px-0">
            <div class="row mx-0 previous_dev_row">
                ...
                <div class="col px-0">
                    <div class="development_location_div d-flex justify-content-end h-100">
                        <div class="mt-5 pe-5 text-end py-5">
                            <h1 class="location_heading"><strong>TOOTING&nbsp;</strong></h1><span class="location_span"><strong>ENSO</strong><br><strong>56 Glenburnie Road</strong><br><strong>Tooting, SW17 7NE</strong><br></span><span class="location_span"><br><strong>7 New 1,2 &amp; 3 Bedroom</strong><br><strong>Apartments</strong><br></span>
                        </div>
                    </div>
                </div>
            </div>
